...
def identify_dvd(job):
    ...
    try:
        ...
        # Dead needs removing
        urlstring = f"http://metaservices.windowsmedia.com/pas_dvd_B/template/GetMDRDVDByCRC.xml?CRC={crc64}"
...
def call_tmdb_service(job, tmdb_api_key, dvd_title, year=""):
    ...
    # https://api.themoviedb.org/3/movie/78?api_key=19f422060743e8f44ddcc59c163539ac
